...
function getBalance(token_address) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    tokenContract = new exports.web3.eth.Contract(ERC20_1.ERC20, token_address);
                    return [4 /*yield*/, tokenContract.methods.balanceOf(exports.useinfo.account).call()];
                case 1:
                    balance = _c.sent();
...
function executeContract(contract, methodName, value, params, callback) {
    var _a;
    (_a = contract.methods)[methodName].apply(_a, __spreadArray([], __read(params))).send({ from: exports.useinfo.account, value: value })
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    exports.useinfo.account = accounts[0];
                    _a = exports.useinfo;
                    return [4 /*yield*/, exports.web3.eth.getChainId()];
                case 3:
                    _a.chainID = _b.sent();
                    resMsg.message = "success";
                    resMsg.account = exports.useinfo.account;
                    resMsg.currentChainID = exports.useinfo.chainID;
                    _ethereum.on("accountsChanged", function (accounts) {
                        exports.useinfo.account = accounts[0];
                        callback({
                            account: exports.useinfo.account,
                            currentChainID: exports.useinfo.chainID,
                            message: "success",
                        });
                    });
